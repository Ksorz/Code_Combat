...
while True:
    ...
    if distance < 10:
        ...
        yakDirection = Vector.subtract(hero.pos, yak.pos)
        # Now use Vector.normalize and Vector.multiply to make it 10m long
        yakDirection = Vector.normalize(yakDirection)
        yakDirection = Vector.multiply(yakDirection, 10)
        # Once you have the 10m vector away from the yak, use Vector.add to add it to your goal vector!
        goal = Vector.add(goal, yakDirection)
        pass
